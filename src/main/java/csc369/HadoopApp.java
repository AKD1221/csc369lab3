...
import csc369.part1.AddressMapper;

import csc369.part1.CountryMapper;
...
public class HadoopApp {
	...
	else if ("part1".equalsIgnoreCase(otherArgs[0])) 
	{
		...
		//MultipleInputs.addInputPath(job, new Path(args[0]), TextInputFormat.class, CountryMapper.class);
		MultipleInputs.addInputPath(job, new Path(otherArgs[0]),TextInputFormat.class, CountryMapper.class);
		MultipleInputs.addInputPath(job, new Path(otherArgs[1]),TextInputFormat.class, AddressMapper.class);
